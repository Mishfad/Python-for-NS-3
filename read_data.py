...
nNodes=15
#a=np.genfromtxt('/Users/mishfadsv/Documents/NS-3/ns-allinone-3.25/ns-3.25/manet-routing-compare.mob',delimiter=' ',dtype=None)
...
for node_index in range(index_plot):
    ...
    pl.title(str(time_plot[node_index]))
# make axis labels
    pl.xlabel('x axis')
    pl.ylabel('y axis')
# set axis limits
